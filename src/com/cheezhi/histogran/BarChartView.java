...
public class BarChartView {
	...
	private static int margins[] = new int[] { 40, 40, 40, 40 };
	...
	public void initData(double[] firstAnswerPercent,
			double[] lastAnswerPercent, List<String> option, String title) {
	...
	public View getBarChartView() {
		buildBarRenderer();
		setChartSettings(renderer, mTitle, "日期", "里程数", 0, 6, 0, 100, Color.BLACK,
				Color.LTGRAY);
		...
		renderer.setPanLimits(new double[] { 0, 13, 0, 40 });
		renderer.setZoomEnabled(true, false);// 设置x，y方向都不可以放大或缩�?
